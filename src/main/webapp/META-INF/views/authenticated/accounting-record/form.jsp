...
<acme:form readonly="true">
	...
	<acme:form-textbox code="authenticated.accounting-record.form.label.bookkeeper" path="bookkeeper"/>
	<acme:form-textbox code="authenticated.accounting-record.form.label.title" path="title"/>
	<acme:form-textbox code="authenticated.accounting-record.form.label.status" path="statusl"/>
